<div class="flex p-4 {{ $loop->last ? '' : 'border-b border-b-gray-400' }}">
    ...
    <div>
        ...
        <div class="flex">
            <div class="flex items-center mr-3 {{ $chirp->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }}">
            ...
            <div class="flex items-center {{ $chirp->isDislikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }}">
                <svg viewBox="0 0 20 20" class="mr-1 w-4">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g class="fill-current">
                            <path
