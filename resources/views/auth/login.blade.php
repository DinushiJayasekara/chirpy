        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body w-full max-w-sm">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row mb-6">
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        <input class="text-gray-800 text-sm" type="checkbox" name="remember"
                            ...
                            <div class="form-group row mb-0 mt-3">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a
                                        class="ml-2 inline-block align-baseline text-sm text-blue-500 hover:text-blue-800 text-xs">|</a>
